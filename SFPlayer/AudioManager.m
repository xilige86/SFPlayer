...
@interface AudioManagerImpl : AudioManager<AudioManagerDelegate> {
    BOOL                        _initialized;
    BOOL                        _activated;
    float                       *_outData;
...
{
    static AudioManagerImpl *audioManager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        audioManager = [[AudioManagerImpl alloc] init];
    });
    return audioManager;
}
@end
...
static void sessionPropertyListener(void *                  inClientData,
                                    ...
                                    const void *            inData)
{
    AudioManagerImpl *sm = (__bridge AudioManagerImpl *)inClientData;
...
{
    AudioManagerImpl *sm = (__bridge AudioManagerImpl *)inRefCon;
